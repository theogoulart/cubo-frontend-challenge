  ...
  return (
    <footer className="border-t border-gray-200 bg-white w-full">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between py-4">
        {/* Address */}
        <div className="text-center md:text-left text-gray-500 text-xs sm:text-sm leading-tight mb-4 md:mb-0">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          {/* Facebook */}
          <a href="#" aria-label="Facebook" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center" style={{ background: '#3b5998' }}>
          ...
          {/* Google+ */}
          <a href="#" aria-label="Google+" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center" style={{ background: '#dd4b39' }}>
            <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Twitter */}
          <a href="#" aria-label="Twitter" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center" style={{ background: '#00acee' }}>
            <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* YouTube */}
          <a href="#" aria-label="YouTube" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center" style={{ background: '#c4302b' }}>
            <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
